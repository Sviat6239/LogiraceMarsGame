        ...
        for (let i = 0; i < player.location.nextLocation.length; i++) {
            ...
            b.onclick = function () {
                ...
                if (currentIdx === 7 && locationVisits[8] === 2 && locationVisits[9] === 2 && subGoals[0].completed === true) {
                    startDialogue(airFiltrationGoalDialogue);
